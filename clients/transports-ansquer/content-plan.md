...
| 08/2026 | création | Empotage et dépotage de conteneur : guide complet du chargeur (étapes, coûts, responsabilités, code CTU) — sans « Gennevilliers » dans le title | empotage conteneur (140) + depotage conteneur (70) — fusion, SERPs recouvrantes | info-commerciale | P2 | guide | A | devis `/devis/` | implantation dans le port (G1, quai 8) ; 🟡 partiel 2026-08-06 : durée « dépend du contenu » + anecdote renfort main-d'œuvre (⚠️ chiffres à reconfirmer) ; grille ⛔ refusée ; photos : stock (décision 2026-08-24) | 🔎 **recherché** — brief de production persisté le 2026-08-28 (`research/2026-08-28-guide-empotage-depotage-conteneur.md`), GO serp-analyst ×2 (volumes à jour : 210 + 110/70), **en attente de GO opérateur** ; 2 décisions ouvertes : arbitrage objectif pilier (national → guide, local → pilier), chiffres de l'anecdote à reconfirmer |
