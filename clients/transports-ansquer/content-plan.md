...
|---|---|---|---|---|
| Tournée régulière — mise en place (08) ⭐ | cadences réelles pratiquées, modèle d'engagement/préavis, exemple de tournée type (anonymisé) | 2026-08-02 | ✅ **reçu** (quotidien 3 camions/secteurs, 6-7 points, engagement souple ; ⚠️ 4ᵉ département et rotations 14 m³ à reconfirmer) | 2026-08-06 |
| Guide empotage/dépotage (08) | durée moyenne d'un dépotage 40', grille tarifaire indicative, photos terrain | 2026-08-02 | 🟡 **partiellement reçu** : durée = « dépend du contenu » + bornes (⚠️ chiffres illisibles) ; grille tarifaire ⛔ **refusée** ; photos en attente | 2026-08-06 |
| Comparatif transport dédié (09) ⭐ | seuils de bascule constatés chez les clients (fréquence, nb de points, coût/livraison) | 2026-08-02 | 🟡 **partiellement reçu** : seuil clair (hebdo = régulier, mensuel = ponctuel, logique tarif à l'année) ; coût/livraison chiffré ⛔ refusé (tarifs) | 2026-08-06 |
| Palettes conteneur (09) | 2-3 cas réels où la théorie du plan de chargement n'a pas tenu (poids, gerbage, calage) | 2026-08-02 | 🟡 **partiellement reçu** : 1 anecdote (conteneur import très chargé → renfort main-d'œuvre anticipé) ; rien sur gerbage/calage | 2026-08-06 |
| Coût tournée externalisée (10) ⭐ | grille tarifaire indicative par gabarit 9/14/20 m³ (au km / à la tournée / au mois), éléments du comparatif vs chauffeur salarié | 2026-08-02 | ⛔ **refusé** (aucune fourchette publiée, décision client 2026-08-06) → sujet à requalifier, voir tableau des sujets | 2026-08-06 |
| Commissionnaire vs transporteur (10) | référence exacte de l'inscription au registre des commissionnaires | 2026-08-02 | 🕓 **en attente** (bloc non abordé à l'entretien) | |
| Refresh homepage (11) | photos réelles flotte/quais/entrepôt | 2026-08-02 | 🕓 **en attente** | |
| Refresh hub urgence (11) | délais réels constatés par zone/département | 2026-08-02 | 🕓 **en attente** | |
| Externalisation PME (01/2027) | coût au m²/palette pratiqué, seuil de bascule constaté, cas client anonymisé | 2026-08-02 | 🕓 **en attente** (coût stockage non abordé) | |
