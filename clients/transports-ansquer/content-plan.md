...
| Commissionnaire vs transporteur (10) | référence exacte de l'inscription au registre des commissionnaires | 2026-08-02 | 🟡 **partiellement reçu** : statut « inscrit au registre » utilisable ; ⛔ **aucun numéro** tant que le certificat DRIEAT n'est pas fourni (le client doit le retrouver) | 2026-08-06 |
| Refresh homepage (11) | photos réelles flotte/quais/entrepôt | 2026-08-02 | ⛔ **indisponible en l'état** : aucune photo de qualité n'existe → 📸 **ACTION : mini-shooting à planifier avec le client** (smartphone : flotte, quais, entrepôt, équipe) — conditionne aussi les photos GBP | |
