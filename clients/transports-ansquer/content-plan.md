...
- [ ] Combien de palettes dans un conteneur (09/2026 — ré-anglé « la table et ses limites de poids », gate 2026-09-02, invariant 14) — 🔎 `/research` fait le 2026-09-13 (`research/2026-09-13-combien-de-palettes-dans-un-conteneur.md`), en attente de GO `/write` → 📝 **rédigé 2026-09-14, PR #7 en attente de GO MERGE**
