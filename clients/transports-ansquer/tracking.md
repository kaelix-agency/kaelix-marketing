...
| 2026-09-14 | création | combien de palettes dans un conteneur (cluster ≈ 230-280 ; 100x120/40' 90), cluster A | `/blog/combien-de-palettes-dans-un-conteneur/` | evergreen | P2 | ✅ publié (PR #7 mergée `0e4784c`, GO MERGE opérateur 14/09 ; renvoi du guide câblé PR #8 `40f6b9f`) | ~2026-10-14 | ~2026-11-13 | **~2026-12-13** | — | table sourcée ISO 668 / EPAL / R312-4 ; sujet « Poids d'un conteneur » candidat cluster A ; URL ISO 668 validée par l'opérateur au gate |
...
| 2026-09-14 | `/blog/combien-de-palettes-dans-un-conteneur/` (4e article) | 2026-12-13 | ⛔ aucune retouche avant J90 ; exception prévue : lien vers le futur article « Poids d'un conteneur » (commentaire MDX) à sa publication. Guide empotage : exception 90 j **consommée** le 14/09 (renvoi câblé, lien seul) |
